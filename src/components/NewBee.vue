    ...
    <div id="helpBoard">
      ...
      <div class="content">
        ...
        <div class="desc">
          ...
          <div v-if="helpStep == 10001">
            Only whitelisted members are allowed to enter the office currently.
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    window['showNotTeammate'] = () => {//No non-company members are allowed in at this time
      this.showNextBtn = true
      this.showCanvas = false
      this.$store.commit("setHelpStep", 10001);
      console.log(this.helpStep)
      this.showHelp = true
    };
